function [AllFold_AllBins,selected_cells,bins_accuracy] = NatScene_decoding_ver8_for20_pooled_ST(ExpID,type,selected_cells,folds)
...
for bins = 2:8
    for fold = 1:folds
        ...
        [RespMatrix,RespMatrixTraining,RespMatrixTesting,RespMatrixAllTrials,ProbDist,BinThresh,removedBlocks_new,selected_cells]=get_prob_dist_ver8_for20_pooled_ST(ExpID,selected_cells,bins,folds,fold);
