...
home = pwd;
cd ../..
NS = load('dataOut_NatScenes_POOLED2.mat');
cd(home)
...
save('all_groups.mat','group_nsresp','group_all');
...
for g = 1
    ...
    [AllFold_AllBins,selected_cells,bins_accuracy] = NatScene_decoding_ver8_for20_pooled_ST(expID,type,selected_cells,folds);
