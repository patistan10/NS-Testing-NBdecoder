function [AllFold_AllBins,selected_cells,bins_accuracy] = NatScene_decoding_ver8_for20_TEST(ExpID,type,selected_cells,folds)
...
for bins = 2
    for fold = 1:folds
        ...
        [RespMatrix,RespMatrixTraining,RespMatrixTesting,RespMatrixAllTrials,ProbDist,BinThresh,removedBlocks,selected_cells]=get_prob_dist_ver8_for20_TEST(ExpID,selected_cells,bins,folds,fold);
